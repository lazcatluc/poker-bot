...
public class ScorerTest {
	...
	public void higherPairWinsEvenIfLowerThirdCard() throws Exception {
		assertThat(new Scorer().compare(Arrays.asList(Card.get(Suit.SPADE, Rank.KING), Card.get(Suit.HEART, Rank.KING), Card.get(Suit.DIAMOND, Rank.TWO)),
				Arrays.asList(Card.get(Suit.CLUB, Rank.TWO), Card.get(Suit.HEART, Rank.TWO), Card.get(Suit.SPADE, Rank.ACE)))).isLessThan(0);
	}
	
	@Test
	public void equalPairHigherCardWins() throws Exception {
		assertThat(new Scorer().compare(Arrays.asList(Card.get(Suit.SPADE, Rank.KING), Card.get(Suit.HEART, Rank.KING), Card.get(Suit.DIAMOND, Rank.TEN)),
				Arrays.asList(Card.get(Suit.CLUB, Rank.KING), Card.get(Suit.DIAMOND, Rank.KING), Card.get(Suit.SPADE, Rank.TWO)))).isLessThan(0);
